 ...
 * an appropriate collection of the requested parts.
 */
...
public @interface Parts {
    ...
    /**
     * Determines the part interface for which parts are searched. This is
     * required since generics are lost during compilation.
     */
    Class<?> value();
}
